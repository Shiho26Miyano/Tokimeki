...
(function() {
  ...
  function SpeechRecorder() {
    ...
    return e('div', { className: 'card shadow-sm p-2 mb-2', style: { maxWidth: 340, margin: '0 auto', background: '#f7f7fa', border: '1px solid #e0e0e0', fontSize: '0.97em' } },
      ...
      e('div', { style: { color: '#666', fontSize: '0.9em', marginBottom: '0.8em' } }, 'e.g. "how did apple stock perform in the past month?" or "what is the average price of tesla in the past week?"'),
...
// --- React Hedge Fund Tool Component ---
(function() {
  const e = React.createElement;
  ...
  function HedgeFundTool() {
    ...
    const strategies = {
      "trend": "Trend Following (MA Crossover)",
    ...
    return e('div', { className: 'card shadow-sm p-4', style: { maxWidth: 800, margin: '0 auto' } },
      e('h3', { className: 'card-title mb-3', style: { color: '#183153' } }, 'Hedge Fund Signal Tool'),
      e('form', { onSubmit: handleSubmit },
        e('div', { className: 'row g-3 mb-3' },
          e('div', { className: 'col-md-4' },
            e('label', { htmlFor: 'symbol', className: 'form-label' }, 'Select companies:'),
            e('select', {
              id: 'symbol',
              className: 'form-select',
              value: symbol,
              ...
              e('option', { value: 'AAPL' }, 'Apple (AAPL)'),
              e('option', { value: 'MSFT' }, 'Microsoft (MSFT)'),
              e('option', { value: 'GOOGL' }, 'Google (GOOGL)'),
              e('option', { value: 'AMZN' }, 'Amazon (AMZN)'),
              e('option', { value: 'META' }, 'Meta (META)'),
              e('option', { value: 'NVDA' }, 'Nvidia (NVDA)'),
              e('option', { value: 'TSLA' }, 'Tesla (TSLA)'),
              e('option', { value: 'NFLX' }, 'Netflix (NFLX)'),
              e('option', { value: 'AMD' }, 'AMD (AMD)'),
              e('option', { value: 'INTC' }, 'Intel (INTC)'),
              e('option', { value: 'BRK-B' }, 'Berkshire Hathaway (BRK-B)'),
              e('option', { value: 'JNJ' }, 'Johnson & Johnson (JNJ)'),
              e('option', { value: 'V' }, 'Visa (V)'),
              e('option', { value: 'JPM' }, 'JPMorgan Chase (JPM)'),
              e('option', { value: 'WMT' }, 'Walmart (WMT)'),
              e('option', { value: 'PG' }, 'Procter & Gamble (PG)'),
              e('option', { value: 'KO' }, 'Coca-Cola (KO)'),
              e('option', { value: 'XOM' }, 'Exxon Mobil (XOM)'),
              e('option', { value: 'SPY' }, 'S&P 500 ETF (SPY)'),
              e('option', { value: 'QQQ' }, 'Nasdaq 100 ETF (QQQ)'),
              e('option', { value: 'VOO' }, 'S&P 500 ETF (VOO)'),
              e('option', { value: 'ARKK' }, 'ARK Innovation ETF (ARKK)'),
              e('option', { value: 'EEM' }, 'Emerging Markets ETF (EEM)'),
              e('option', { value: 'XLF' }, 'Financial Select Sector SPDR (XLF)'),
              e('option', { value: 'ES=F' }, 'S&P 500 E-mini (ES=F)'),
              e('option', { value: 'NQ=F' }, 'Nasdaq 100 E-mini (NQ=F)'),
              e('option', { value: 'YM=F' }, 'Dow Jones E-mini (YM=F)'),
              e('option', { value: 'RTY=F' }, 'Russell 2000 E-mini (RTY=F)'),
              e('option', { value: 'MES=F' }, 'Micro E-mini S&P 500 (MES=F)'),
              e('option', { value: 'MNQ=F' }, 'Micro E-mini Nasdaq 100 (MNQ=F)'),
              e('option', { value: 'MYM=F' }, 'Micro E-mini Dow (MYM=F)'),
              e('option', { value: 'M2K=F' }, 'Micro E-mini Russell 2000 (M2K=F)'),
              e('option', { value: 'GC=F' }, 'Gold (GC=F)'),
              e('option', { value: 'SI=F' }, 'Silver (SI=F)'),
              e('option', { value: 'CL=F' }, 'Crude Oil WTI (CL=F)'),
              e('option', { value: 'BZ=F' }, 'Brent Oil (BZ=F)'),
              e('option', { value: 'NG=F' }, 'Natural Gas (NG=F)'),
              e('option', { value: 'HG=F' }, 'Copper (HG=F)'),
              e('option', { value: 'ZC=F' }, 'Corn (ZC=F)'),
              e('option', { value: 'ZS=F' }, 'Soybeans (ZS=F)'),
              e('option', { value: 'ZW=F' }, 'Wheat (ZW=F)'),
              e('option', { value: 'VX=F' }, 'VIX (VX=F)'),
              e('option', { value: 'BTC=F' }, 'Bitcoin Futures (BTC=F)'),
              e('option', { value: 'ETH=F' }, 'Ethereum Futures (ETH=F)')
            )
          ),
          e('div', { className: 'col-md-4' },
            e('label', { htmlFor: 'strategy', className: 'form-label' }, 'Strategy:'),
            e('select', {
              id: 'strategy',
              className: 'form-select',
              value: strategy,
          ...
          e('div', { className: 'col-md-4' },
            e('label', { htmlFor: 'period', className: 'form-label' }, 'Time Period:'),
            e('select', {
              id: 'period',
              className: 'form-select',
              value: period,
      ...
      error && e('div', { className: 'alert alert-danger mt-3' }, error),
      result && e('div', { className: 'mt-4' },
        e('div', { className: 'row g-3' },
          e('div', { className: 'col-md-6' },
            e('div', { className: 'card h-100' },
              e('div', { className: 'card-body' },
                e('h5', { className: 'card-title' }, 'Performance Metrics'),
                e('div', { className: 'list-group list-group-flush' },
                  e('div', { className: 'list-group-item d-flex justify-content-between align-items-center' },
                    'Total Return',
                    e('span', { className: 'badge bg-primary rounded-pill' }, result.metrics.total_return)
                  ),
                  e('div', { className: 'list-group-item d-flex justify-content-between align-items-center' },
                    'Sharpe Ratio',
                    e('span', { className: 'badge bg-primary rounded-pill' }, result.metrics.sharpe_ratio)
                  ),
                  e('div', { className: 'list-group-item d-flex justify-content-between align-items-center' },
                    'Max Drawdown',
                    e('span', { className: 'badge bg-danger rounded-pill' }, result.metrics.max_drawdown)
                  ),
                  e('div', { className: 'list-group-item d-flex justify-content-between align-items-center' },
                    'Value at Risk (95%)',
                    e('span', { className: 'badge bg-warning rounded-pill' }, result.metrics.var_95)
                  )
                )
              )
            )
          ...
          e('div', { className: 'col-md-6' },
            e('div', { className: 'card h-100' },
              e('div', { className: 'card-body' },
                e('h5', { className: 'card-title' }, 'Latest Signal'),
                e('div', { className: 'list-group list-group-flush' },
                  e('div', { className: 'list-group-item' },
                    e('div', { className: 'd-flex justify-content-between' },
                      e('span', null, 'Date:'),
                      e('span', null, result.latest_signals.date)
                    )
                  ),
                  e('div', { className: 'list-group-item' },
                    e('div', { className: 'd-flex justify-content-between' },
                      e('span', null, 'Signal:'),
                      e('span', { 
                        className: `badge ${result.latest_signals.signal > 0 ? 'bg-success' : result.latest_signals.signal < 0 ? 'bg-danger' : 'bg-secondary'} rounded-pill`
                      }, result.latest_signals.signal > 0 ? 'BUY' : result.latest_signals.signal < 0 ? 'SELL' : 'NEUTRAL')
                    )
                  ),
                  e('div', { className: 'list-group-item' },
                    e('div', { className: 'd-flex justify-content-between' },
                      e('span', null, 'Price:'),
                      e('span', null, `$${result.latest_signals.price.toFixed(2)}`)
                    )
                  )
                )
              )
